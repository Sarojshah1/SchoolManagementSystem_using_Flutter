...
import 'package:schoolmanagementsystem/Screens/AuthScreen/services/bloc/authentication_bloc.dart';
import 'package:schoolmanagementsystem/Screens/AuthScreen/services/bloc/authentication_event.dart';
import 'package:schoolmanagementsystem/Screens/AuthScreen/services/bloc/authentication_state.dart';
      ...
      body: BlocListener<AuthenticationBloc, AuthenticationState>(
        listener: (context, state) {
          if (state is AuthenticationAuthenticated) {
            ...
            VxToast.show(context, msg: "Logged in to Student Protel");
